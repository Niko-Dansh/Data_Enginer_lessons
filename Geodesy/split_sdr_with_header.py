...
# -*- coding: utf-8 -*-
"""
split_sdr_with_header.py

Тот же split_sdr.py, но с сохранением первых N заголовочных строк во все файлы.
Использование:
    python split_sdr_with_header.py Koord.SDR ST1 ST2 ST3
Результат:
    ST1.SDR, ST2.SDR, ST3.SDR с первыми 4 строками + только свои станции.
"""
...
def main():
    if len(sys.argv) < 3:
        print("Использование: python split_sdr_with_header.py Koord.SDR ST1 ST2 ST3 ...")
        sys.exit(1)
